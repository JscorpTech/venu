...
$("#bring_transfer_money").on("shown.bs.collapse", function() {
    $("#bring_change_amount_btn").text($(this).data("less"));
});

$("#bring_transfer_money").on("hidden.bs.collapse", function() {
...
$(document).ready(function() {
    ...
    $("input").on("change", function() {
        bringTransferMoneySectionRender();
        bringChangeAmountSectionRender();
    });

    function bringTransferMoneySectionRender() {
        if ($("#transfer-money-btn").prop("checked")) {
            $(".bring_transfer_money_section").slideDown();
        } else {
            $(".bring_transfer_money_section").slideUp();
        }
    }
    ...
    $("#transfer_input").on("keyup keypress change", function() {
        $("#transfer_value").val($(this).val());
    });
});
