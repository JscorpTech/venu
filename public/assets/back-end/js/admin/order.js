...
$('#from_date,#to_date').change(function() {
    ...
    if (fr != '' && to != '') {
        if (fr > to) {
            $('#from_date').val('');
            $('#to_date').val('');
            toastMagic.error('{{translate("invalid_date_range")}}!');
        }
    }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.customer_status == 0) {
                        ...
                        location.reload();
                        toastMagic.success($("#message-status-success-text").data('text'));
                    }
                }
            });
        }
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.success == 0) {
                        toastMagic.success($("#message-order-status-delivered-text").data('text'));
                        location.reload();
                    } else {
                        if (data.payment_status == 0) {
                            toastMagic.warning($("#message-order-status-paid-first-text").data('text'));
                            location.reload();
