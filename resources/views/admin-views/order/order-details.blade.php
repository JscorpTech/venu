                                ...
                                <div class="d-flex flex-column gap-2 mt-3">
                                    ...
                                    <div class="payment-status d-flex justify-content-sm-end gap-10">
                                        ...
                                        @if($order['payment_status']=='paid')
                                            <span class="text-success payment-status-span fw-bold">
                                                {{translate('paid')}}
                                            </span>
                                        @else
                                            <span class="text-danger payment-status-span fw-bold">
                                                {{translate('unpaid')}}
                                            </span>
                                        @endif
                                    </div>
                                    ...
                                    @if(getWebConfig('order_verification'))
                                        <span class="payment-status d-flex justify-content-sm-end gap-10">
                                            <b>
