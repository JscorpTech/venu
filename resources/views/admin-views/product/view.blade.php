...
@section('content')
    <div class="content container-fluid text-start">
        ...
        <div class="card card-top-bg-element">
            <div class="card-body">
                <div>
                    <div class="media flex-nowrap flex-column flex-md-row gap-3 flex-grow-1 align-items-center align-items-md-start">
                        <div class="d-flex flex-column align-items-center min-w-165">
                            <div class="position-relative">
                                @if($product?->clearanceSale)
                                    <div class="position-absolute z-1 badge badge-warning text-bg-warning user-select-none mb-2">
                        ...
                        <div class="d-block flex-grow-1 w-max-md-100">
                                   ...
                                   <div class="d-flex flex-wrap gap-2 align-items-center justify-content-end">
                                        @if($product['added_by'] == 'seller' && ($product['request_status'] == 0 || $product['request_status'] == 1))
                                            <div class="d-flex justify-content-sm-end flex-wrap gap-2 pb-4">
                                                <div>
                                                    <button class="btn btn-danger p-2 px-3" data-bs-toggle="modal" data-bs-target="#publishNoteModal">
                                                        {{ translate('reject') }}
                                                    </button>
                                                </div>
                                                <div>
                            ...
                            <div class="d-flex flex-wrap align-items-center flex-sm-nowrap justify-content-between gap-3 min-h-50">
                                ...
                                <div class="d-flex gap-3 flex-nowrap lh-1 badge text-bg-info badge-info fw-semibold justify-content-sm-end h-30 align-items-center">
                                            ...
                                            <div class="">
                                                <ul class="list-unstyled list-unstyled-py-2 d-flex flex-column gap-2 mb-0">
                                                    ...
                                                    <li class="d-flex align-items-center fs-12">
                                                        ...
                                                        <span class="{{ Session::get('direction') === "rtl" ? 'ml-3' : 'me-3' }}">
                            ...
                            <div class="tab-content mt-3" id="pills-tabContent">
                                @foreach($languages as $language)
                                        ...
                                        ?>
                                    <div class="tab-pane fade {{ $language == $defaultLanguage ? 'show active' : '' }}" id="{{ $language}}-form" aria-labelledby="{{$language}}-link" role="tabpanel">
                                        <div class="d-flex gap-2 align-items-center mb-2">
                                            <h2 class="h1 mb-0 text-dark">{{ $translate[$language]['name'] ?? $product['name'] }}</h2>
                                ...
                                <table
                                    ...
                                    @foreach($product->digitalVariation as $key => $variation)
                                        <tr>
                                            ...
                                            @if($product->digital_product_type == 'ready_product')
                                            <td class="text-center">
                                                <span class="btn p-0 getDownloadFileUsingFileUrl" data-bs-toggle="tooltip" data-bs-title="{{ !is_null($variation->file_full_url['path']) ? translate('download') : translate('File_not_found') }}" data-file-path="{{ $variation->file_full_url['path'] }}">
                                                    <img src="{{ dynamicAsset(path: 'public/assets/back-end/img/icons/download-green.svg') }}" alt="">
                                                </span>
                                            </td>
                                            @endif
                        ...
                        @if($product?->seoInfo?->image_full_url['path'] || $product->meta_image_full_url['path'])
                            <div class="d-flex flex-wrap gap-2">
                                <a data-bs-toggle="modal"
                                   data-bs-target="#imgViewModal-seo-{{ $product->id }}"
                                   data-type="image"
                                   href="javascript:"
                                ...
                                <div class="modal fade imgViewModal" id="imgViewModal-seo-{{ $product->id }}"
                                     tabindex="-1"
                                     aria-labelledby="imgViewModal-seo-{{ $product->id }}Label" role="dialog"
                                     aria-modal="true">
                                ...
                                <td>
                                    <div class="d-flex gap-2 justify-content-center">
                                        <div data-bs-toggle="modal" data-bs-target="#review-view-for-{{ $review['id'] }}">
                                            <a class="btn btn-outline-info icon-btn" data-bs-title="{{ translate('View') }}" data-bs-toggle="tooltip">
                                        ...
                                        @if(isset($review->product) && $review?->product?->added_by == 'admin')
                                            <div data-bs-toggle="modal" data-bs-target="#review-update-for-{{ $review['id'] }}">
                                                @if($review?->reply)
                                                    <a class="btn btn-outline-primary icon-btn" data-bs-title="{{ translate('Update_Review') }}" data-bs-toggle="tooltip">
                                                        <i class="fi fi-sr-pencil"></i>
                                                    </a>
                                                @else
                                                    <div class="btn btn-outline-primary icon-btn" data-bs-title="{{ translate('Review_Reply') }}" data-bs-toggle="tooltip">
                                        ...
                                        @elseif($review?->product?->added_by == 'seller')
                                            <div>
                                                <a class="btn btn-outline-primary icon-btn" data-bs-title="{{ translate('Admin_can_not_reply_to_vendor_product_review') }}" data-bs-toggle="tooltip">
                                                    @if($review?->reply)
                                                        <i class="fi fi-sr-pencil"></i>
                                                    @else
                                                        <i class="fi fi-sr-reply-all"></i>
                                        ...
                                        @else
                                            <div>
                                                <a class="btn btn-outline-primary icon-btn" data-bs-title="{{ translate('product_not_found') }}" data-bs-toggle="tooltip">
                                                    @if($review?->reply)
                                                        <i class="fi fi-sr-pencil"></i>
                                                    @else
                                                        <i class="fi fi-sr-reply-all"></i>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close text-BFBFBF" data-bs-dismiss="modal" aria-label="Close">
