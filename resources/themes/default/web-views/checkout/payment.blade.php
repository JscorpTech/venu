                            ...
                            @else
                                ...
                                @if (
                                    ...
                                    @if (($cashOnDeliveryBtnShow && $cash_on_delivery['status']) || (auth('customer')->check() && $wallet_status == 1))
                                        ...
                                        <div class="d-flex flex-wrap gap-3 mb-3">
                                            @if ($cashOnDeliveryBtnShow && $cash_on_delivery['status'])
                                                            ...
                                                            <label class="m-0">
                                                                ...
                                                                <span
                                                                    ...
                                                                    <img width="20"
                                                                        ...
                                                                        alt="">
                                                                    <span
                                                                        class="fs-12">{{ translate('cash_on_Delivery') }}</span>
                                                                </span>
                                                            </label>
                                                        </form>
                                                    </div>
                                                ...
                                                <div id="transfer-money">
                                                    <div class="card cursor-pointer">
                                                        <form action="{{ route('checkout-complete') }}" method="get"
                                                            class="needs-validation" id="transfer-money-btn_form">
                                                            <label class="m-0">
                                                                <input type="hidden" name="payment_method"
                                                                    value="transfer">
                                                                <input type="hidden" class="form-control" name="inn"
                                                                    required id="transfer_value">
                                                                <span
                                                                    class="btn btn-block click-if-alone d-flex gap-2 align-items-center cursor-pointer">
                                                                    <input type="radio" id="transfer-money-btn"
                                                                        class="custom-radio">
                                                                    <img width="20"
                                                                        src="{{ theme_asset(path: 'public/assets/front-end/img/icons/money.png') }}"
                                                                        alt="">
                                                                    <span
                                                                        class="fs-12">{{ translate('transfer_money') }}</span>
                                                                </span>
                                                            </label>
                                                        </form>
                                                    </div>
                                        ...
                                        <div class="bring_transfer_money_section d--none">
                                            <div class=" mb-10px">
                                                <div
                                                    ...
                                                    <div class="col-sm-6">
                                                        <h6 class="fs-12 mb-1 fw-bold">
                                                            {{ translate('transfer_money_title') }}
                                                        </h6>
                                                        <p class="mb-0 fs-12 opacity-50">
                                                            {{ translate('transfer_money_desc') }}
                                                        </p>
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <label class="fs-12 fw-bold" for="">
                                                            {{ translate('transfer_money_label') }}
                                                        </label>
                                                        <input type="text" required class="form-control max-w-210px"
                                                            id="transfer_input" placeholder="{{ translate('inn/pinfl') }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        @if ($cashOnDeliveryBtnShow && $cash_on_delivery['status'])
                                            <div class="bring_change_amount_section d--none">
                                                <div class="collapse mb-10px" id="bring_change_amount"
